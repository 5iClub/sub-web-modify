...
export default {
  ...
  methods: {
    ...
    tanchuang() {
      this.$alert(`<div style="text-align:center; font-size: 16px;"><strong>言氏稗客 | 提供维护:</strong> <a href="https://t.me/sspai_eu" target="_blank" style="color: #409EFF; text-decoration: none;">TG群组</a> <a href="https://d.zrf.me/blog" target="_blank" style="color: #409EFF; text-decoration: none;">Blog</a></div>`, '信息面板', {
